...
from utils.models import Reaction
...
#                 print(f"Error occurred for {item}. Retrying...")
...
#     def _prepare_request(self, cast_hash: str, cursor: Optional[str] = None) -> tuple:
#         url = f"{self.base_url}?castHash={cast_hash}&limit=100"
#         if cursor:
#             url += f"&cursor={cursor}"
#         headers = {"Authorization": f"Bearer {self.bearer_token}"}
#         timeout = aiohttp.ClientTimeout(total=10)
#         return url, headers, timeout, "GET", None
